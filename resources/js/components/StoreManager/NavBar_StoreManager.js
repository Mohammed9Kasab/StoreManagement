...
export default function NavBar_StoreManager() {
    ...
    function getCountOrders(){
        ...
        axios.get('http://localhost:8000/api/getAcceptedOrdersCount',{
            headers: {
            ...
            >
                <Toolbar>
                    ...
                    <Typography variant="h6" noWrap>
                        Welcome {localStorage.getItem('user_name')} (Manager)
                    </Typography>
                </Toolbar>
            </AppBar>
            <Drawer
            ...
            >
                ...
                <List component="nav" aria-label="main mailbox folders">
                    ...
                    <ListItem button selected={selectedIndex === 2}
                              onClick={(event) => {setCountNewOrders(0);
